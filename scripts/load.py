    ...
    try:
        ...
        if not username:
            ...
            if not username:
                username = "postgres"
            print(
                f"Warning: No username found in DATABASE_URL, using '{username}' as default"
            )

        # Build properties dictionary
        properties = {"driver": "org.postgresql.Driver", "user": username}
        ...
        if password is not None:
            ...
            print(
                "Warning: No password provided - ensure PostgreSQL is configured for trust/peer authentication"
            )
