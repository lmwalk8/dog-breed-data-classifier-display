...
def load_breeds_from_database():
    ...
    try:
        ...
        with engine.connect() as connection:
            query = text(
                'SELECT DISTINCT "Breed Name" FROM dog_breed_data WHERE "Breed Name" IS NOT NULL ORDER BY "Breed Name"'
            )
            ...
            if row:
                ...
                try:
                    ...
                    columns = (
                        ...
                        else [desc[0] for desc in result.cursor.description]
                    )
...
def dog(breed):
    ...
    if not breed_data:
        ...
        return (
            render_template(
                "dog.html", breed=breed, breed_data=None, error="Breed not found"
            ),
            404,
        )
...
def visualization():
    ...
    return render_template(
        "visualization.html",
        title="Dog Breed Data Visualizations",
